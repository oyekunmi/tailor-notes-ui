...
/***/ "./src/app/notes/note-field-display.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/notes/note-field-display.component.ts ***!
  \*******************************************************/
/*! exports provided: NoteFieldDisplay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NoteFieldDisplay", function() { return NoteFieldDisplay; });
...
var NoteFieldDisplay = /** @class */ (function () {
    function NoteFieldDisplay() {
    }
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], NoteFieldDisplay.prototype, "noteField", void 0);
    NoteFieldDisplay = __decorate([
...
/***/ "./src/app/notes/note-resolver.service.ts":
/*!************************************************!*\
  !*** ./src/app/notes/note-resolver.service.ts ***!
  \************************************************/
/*! exports provided: NoteResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NoteResolver", function() { return NoteResolver; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var NoteResolver = /** @class */ (function () {
    ...
    NoteResolver.prototype.resolve = function (route, state) {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].of(true);
    };
...
/***/ "./src/app/notes/note.component.scss":
/*!*******************************************!*\
  !*** ./src/app/notes/note.component.scss ***!
  \*******************************************/
/*! no static exports found */
...
module.exports = "article.note-teaser {\n  background: #fff;\n  box-shadow: 0 2px 1px -1px rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.14), 0 1px 3px 0 rgba(0, 0, 0, 0.12);\n  padding: 10px;\n  border-radius: 10px;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-columns: 1fr 9fr;\n      grid-template-columns: 1fr 9fr;\n  -webkit-column-gap: 10px;\n          column-gap: 10px;\n  font-size: 1em;\n  cursor: pointer; }\n  article.note-teaser .note-image {\n    display: flex;\n    align-items: center;\n    justify-content: center; }\n  article.note-teaser .note-image mat-icon {\n      font-size: 3em;\n      height: auto;\n      width: auto; }\n  article.note-teaser .note-summary {\n    margin-top: 5px; }\n  article.note-teaser .note-full {\n    margin-top: 10px;\n    padding-top: 10px;\n    border-top: solid thin #2AA330;\n    display: -ms-grid;\n    display: grid;\n    grid-gap: 10px;\n    -ms-grid-columns: (1fr)[3];\n        grid-template-columns: repeat(3, 1fr); }\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _note_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./note.model */ "./src/app/notes/note.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NoteComponent = /** @class */ (function () {
    ...
    NoteComponent.prototype.ngOnInit = function () {
        this.summaryItems = this.note.measures.filter(function (x, i) { return i < 3; });
        this.showFull = false;
    };
    NoteComponent.prototype.toggleTeaser = function () {
        this.showFull = !this.showFull;
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _note_model__WEBPACK_IMPORTED_MODULE_1__["MeasurementClass"])
    ...
    NoteComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./note.component.scss */ "./src/app/notes/note.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], NoteComponent);
...
/*!*************************************!*\
  !*** ./src/app/notes/note.model.ts ***!
  \*************************************/
/*! exports provided: MeasurementClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeasurementClass", function() { return MeasurementClass; });
var MeasurementClass = /** @class */ (function () {
    function MeasurementClass(note) {
        this.id = note.id;
        this.name = note.name;
...
var NoteService = /** @class */ (function () {
    ...
    NoteService.prototype.getNotes = function (count) {
        var measures = [
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].of(measures).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return data.filter(function (item) { return item.id !== ''; }); }), Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('getNotes')));
    };
    NoteService.prototype.handleError = function (operation) {
...
/* harmony import */ var _note_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./note.component */ "./src/app/notes/note.component.ts");
/* harmony import */ var _note_resolver_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./note-resolver.service */ "./src/app/notes/note-resolver.service.ts");
...
var routes = [
    ...
    {
        path: ':title',
        component: _note_component__WEBPACK_IMPORTED_MODULE_2__["NoteComponent"],
        resolve: {
            note: _note_resolver_service__WEBPACK_IMPORTED_MODULE_3__["NoteResolver"]
        }
    }
];
...
module.exports = ".error-plate {\n  padding: 15px;\n  background: #bf3c3c;\n  margin: 15px;\n  color: #fff;\n  font-size: 16px;\n  font-weight: 500; }\n  .error-plate span {\n    vertical-align: 10px; }\n  .error-plate mat-icon {\n    font-size: 35px;\n    width: 50px;\n    height: 35px; }\n  :host .notes-list {\n  padding: 0 10px;\n  display: -ms-grid;\n  display: grid;\n  grid-row-gap: 10px; }\n  :host .floating-nav {\n  position: fixed;\n  bottom: 10%;\n  right: 10px; }\n  :host .floating-nav a mat-icon {\n    font-size: 3em;\n    color: #25d366;\n    fill: white;\n    height: auto;\n    width: auto; }\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _note_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./note.service */ "./src/app/notes/note.service.ts");
...
var NotesComponent = /** @class */ (function () {
    function NotesComponent(noteService, appContext) {
        this.noteService = noteService;
        this.appContext = appContext;
        this.loadingError$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
    }
    NotesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.appContext.moduleTitle.next("Measurements");
        this.notes = this.noteService.getNotes().pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
    ...
    NotesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_note_service__WEBPACK_IMPORTED_MODULE_2__["NoteService"], _shared__WEBPACK_IMPORTED_MODULE_5__["ContextService"]])
    ], NotesComponent);
...
/* harmony import */ var _notes_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./notes-routing.module */ "./src/app/notes/notes-routing.module.ts");
...
/* harmony import */ var _note_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./note.component */ "./src/app/notes/note.component.ts");
/* harmony import */ var _note_resolver_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./note-resolver.service */ "./src/app/notes/note-resolver.service.ts");
/* harmony import */ var _note_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./note.service */ "./src/app/notes/note.service.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var _note_field_display_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./note-field-display.component */ "./src/app/notes/note-field-display.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NotesModule = /** @class */ (function () {
    ...
    NotesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_note_resolver_service__WEBPACK_IMPORTED_MODULE_5__["NoteResolver"], _note_service__WEBPACK_IMPORTED_MODULE_6__["NoteService"]],
            declarations: [_notes_component__WEBPACK_IMPORTED_MODULE_3__["NotesComponent"], _note_component__WEBPACK_IMPORTED_MODULE_4__["NoteComponent"], _note_field_display_component__WEBPACK_IMPORTED_MODULE_8__["NoteFieldDisplay"]]
        })
    ], NotesModule);
    return NotesModule;
}());
